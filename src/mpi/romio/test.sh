...
# Generated by GNU Autoconf 2.69 for ROMIO 4.0a1.
#
...
FILE_SYS_DIRS
EXTRA_SRC_DIRS
MPIO_GLUE_DEFAULT_FALSE
MPIO_GLUE_DEFAULT_TRUE
MPIO_GLUE_OPENMPI_FALSE
MPIO_GLUE_OPENMPI_TRUE
MPIO_GLUE_MPICH_FALSE
MPIO_GLUE_MPICH_TRUE
DOCTEXT
...
main_top_srcdir
srcdir
LUSTRE_LOCKAHEAD_FALSE
LUSTRE_LOCKAHEAD_TRUE
BUILD_AD_PE_FALSE
BUILD_AD_PE_TRUE
BUILD_AD_BG_FALSE
BUILD_AD_BG_TRUE
...
BUILD_AD_QUOBYTEFS_FALSE
BUILD_AD_QUOBYTEFS_TRUE
BUILD_AD_IME_FALSE
BUILD_AD_IME_TRUE
BUILD_AD_GPFS_FALSE
BUILD_AD_GPFS_TRUE
...
BUILD_AD_XFS_FALSE
BUILD_AD_XFS_TRUE
BUILD_AD_MADFS_FALSE
BUILD_AD_MADFS_TRUE
BUILD_AD_TESTFS_FALSE
...
BUILD_F77_BINDINGS_TRUE
BUILD_PROFILING_LIB_FALSE
BUILD_PROFILING_LIB_TRUE
BUILD_MPIO_ERRHAN_FALSE
BUILD_MPIO_ERRHAN_TRUE
BUILD_MPIO_REQUEST_FALSE
BUILD_MPIO_REQUEST_TRUE
BUILD_ROMIO_EMBEDDED_FALSE
BUILD_ROMIO_EMBEDDED_TRUE
HAVE_WEAK_SYMBOLS
ac_ct_FC
FCFLAGS
FC
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
\`configure' configures ROMIO 4.0a1 to adapt to many kinds of systems.
...
Fine tuning of the installation directories:
  ...
  --docdir=DIR            documentation root [DATAROOTDIR/doc/romio]
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of ROMIO 4.0a1:";;
   esac
  cat <<\_ACEOF
...
--with-mpi=path   - Path to instalation of MPI (headers, libs, etc)
  --with-daos             Build DAOS ROMIO driver[default=no]
  --with-daos=[PATH]      specify path where daos include directory and lib
  ...
  --with-daos-include=PATH
                          specify path where daos include directory can be
                          found
  --with-daos-lib=PATH    specify path where daos lib directory can be found
  --with-madfs            Build MADFS ROMIO driver[default=no]
  --with-madfs=[PATH]     specify path where madfs include directory and lib
                          directory can be found. Having this option
                          explicitly requires the library. When PATH is not
                          given, it checks the library from system paths.
  --with-madfs-include=PATH
                          specify path where madfs include directory can be
                          found
  --with-madfs-lib=PATH   specify path where madfs lib directory can be found
...
Some influential environment variables:
  ...
  main_top_srcdir
              set by the MPICH configure to indicate the MPICH source root
  main_top_builddir
              set by the MPICH configure to indicate the MPICH build root
...
Report bugs to <discuss@mpich.org>.
ROMIO home page: <http://www.mpich.org/>.
_ACEOF
ac_status=$?
fi
...
It was created by ROMIO $as_me 4.0a1, which was
...
if test -n "$CONFIGURE_ARGS" ; then
    { $as_echo "$as_me:${as_lineno-$LINENO}: Configuring with args $CONFIGURE_ARGS" >&5
$as_echo "$as_me: Configuring with args $CONFIGURE_ARGS" >&6;}
fi

ac_config_headers="$ac_config_headers adio/include/romioconf.h"
...
known_filesystems="daos nfs ufs pvfs2 testfs madfs xfs panfs lustre gpfs ime quobytefs"
...
# Check whether --with-mpi-impl was given.
if test "${with_mpi_impl+set}" = set; then :
  withval=$with_mpi_impl;
fi
...
$as_echo "Unknown!" >&6; }
       as_fn_error $? "Error: Could not guess target architecture, you must
set an architecture type with the environment variable ARCH" "$LINENO" 5
    fi
    eval "arch_$ARCH=1"
...
if test $? != 0 ; then
   { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: Unknown architecture $ARCH... proceeding anyway" >&5
$as_echo "$as_me: WARNING: Unknown architecture $ARCH... proceeding anyway" >&2;}
fi
#
#
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: result: ROMIO home directory is $ROMIO_HOME_TRIAL" >&5
$as_echo "ROMIO home directory is $ROMIO_HOME_TRIAL" >&6; }
...
if test -n "$MPI_IMPL" ; then
   ...
   if test $found = no ; then
      { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: Unknown MPI implementation $MPI... proceeding anyway" >&5
$as_echo "$as_me: WARNING: Unknown MPI implementation $MPI... proceeding anyway" >&2;}
   fi
fi
#
...
if test $WITHIN_KNOWN_MPI_IMPL = no ; then
   if test -n "$MPI_INCLUDE_DIR"; then
      if test ! -f "$MPI_INCLUDE_DIR/mpi.h" ; then
         as_fn_error $? "Include file $MPI_INCLUDE_DIR/mpi.h not found" "$LINENO" 5
      fi
   else
...
if test $WITHIN_KNOWN_MPI_IMPL = no ; then
   if test -n "$MPI_LIB" ; then
      if test ! -f "$MPI_LIB" ; then
         as_fn_error $? "MPI library $MPI_LIB not found" "$LINENO" 5
      fi
   fi
fi
...
if test -n "$ac_tool_prefix"; then
  for ac_prog in PAC_F77_SEARCH_LIST
  do
    # Extract the first word of "$ac_tool_prefix$ac_prog", so it can be a program name with args.
set dummy $ac_tool_prefix$ac_prog; ac_word=$2
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for $ac_word" >&5
...
if test -n "$ac_tool_prefix"; then
  for ac_prog in PAC_FC_SEARCH_LIST
  do
    # Extract the first word of "$ac_tool_prefix$ac_prog", so it can be a program name with args.
set dummy $ac_tool_prefix$ac_prog; ac_word=$2
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for $ac_word" >&5
...
if test -n "$arch_IRIX"; then
   { $as_echo "$as_me:${as_lineno-$LINENO}: checking for IRIX OS version" >&5
$as_echo_n "checking for IRIX OS version... " >&6; }
               osversion=`uname -r | sed 's/\..*//'`
               osvminor=`uname -r | sed 's/[0-9]\.\([0-9]*\)\..*/\1/'`
      { $as_echo "$as_me:${as_lineno-$LINENO}: result: $osversion" >&5
$as_echo "$osversion" >&6; }
      { $as_echo "$as_me:${as_lineno-$LINENO}: checking for IRIX cpucount" >&5
$as_echo_n "checking for IRIX cpucount... " >&6; }
      cpucount=`hinv | grep '[0-9]* [0-9]* MHZ IP[0-9]* Proc' | cut -f 1 -d' '`
   if test "$cpucount" = "" ; then
     cpucount=`hinv | grep 'Processor [0-9]*:' | wc -l | sed -e 's/ //g'`
   fi
      if test "$cpucount" = "" ; then
     { $as_echo "$as_me:${as_lineno-$LINENO}: result: Could not determine cpucount.  Please send" >&5
$as_echo "Could not determine cpucount.  Please send" >&6; }
     hinv
     as_fn_error $? "to romio-maint@mcs.anl.gov" "$LINENO" 5
   fi
   { $as_echo "$as_me:${as_lineno-$LINENO}: result: $cpucount" >&5
$as_echo "$cpucount" >&6; }
      { $as_echo "$as_me:${as_lineno-$LINENO}: checking for IRIX cpumodel" >&5
$as_echo_n "checking for IRIX cpumodel... " >&6; }
            cputype=`hinv -t cpu | tail -1 | cut -f 3 -d' '`
   if test -z "$cputype" ; then
        { $as_echo "$as_me:${as_lineno-$LINENO}: result: Could not get cputype from hinv -t cpu command. Please send" >&5
$as_echo "Could not get cputype from hinv -t cpu command. Please send" >&6; }
        hinv -t cpu 2>&1
        hinv -t cpu | cut -f 3 -d' ' 2>&1
	as_fn_error $? "to romio-maint@mcs.anl.gov" "$LINENO" 5
   fi
   { $as_echo "$as_me:${as_lineno-$LINENO}: result: $cputype" >&5
$as_echo "$cputype" >&6; }
            if test -z "$osversion" ; then
        { $as_echo "$as_me:${as_lineno-$LINENO}: result: Could not determine OS version.  Please send" >&5
$as_echo "Could not determine OS version.  Please send" >&6; }
        uname -a
        as_fn_error $? "to romio-maint@mcs.anl.gov" "$LINENO" 5
       ...
       { $as_echo "$as_me:${as_lineno-$LINENO}: result: Could not recognize the version of IRIX (got $osversion).
ROMIO knows about versions 4, 5 and 6; the version being returned from
uname -r is $osversion.  Please send" >&5
$as_echo "Could not recognize the version of IRIX (got $osversion).
ROMIO knows about versions 4, 5 and 6; the version being returned from
uname -r is $osversion.  Please send" >&6; }
       uname -a 2>&1
       hinv 2>&1
       as_fn_error $? "to romio-maint@mcs.anl.gov" "$LINENO" 5
   fi
   { $as_echo "$as_me:${as_lineno-$LINENO}: checking for cputype" >&5
$as_echo_n "checking for cputype... " >&6; }
   OLD_ARCH=IRIX
   IRIXARCH="$ARCH_$osversion"
	...
	12000);;
        *)
	{ $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: Unexpected IRIX/MIPS chipset $cputype.  Please send the output" >&5
$as_echo "$as_me: WARNING: Unexpected IRIX/MIPS chipset $cputype.  Please send the output" >&2;}
        uname -a 2>&1
        hinv 2>&1
        { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: to romio-maint@mcs.anl.gov
ROMIO will continue and assume that the cputype is
compatible with a MIPS 4400 processor." >&5
$as_echo "$as_me: WARNING: to romio-maint@mcs.anl.gov
ROMIO will continue and assume that the cputype is
compatible with a MIPS 4400 processor." >&2;}
        cputype=4400
        ;;
   esac
   { $as_echo "$as_me:${as_lineno-$LINENO}: result: $cputype" >&5
...
if test $NOF77 = 0 ; then
    { $as_echo "$as_me:${as_lineno-$LINENO}: checking Fortran external names" >&5
$as_echo "$as_me: checking Fortran external names" >&6;}
...
EOF
   ...
   if test ! -s confftest.$OBJEXT ; then
	{ $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: Unable to test Fortran compiler.  Compiling a test
program failed to produce an object file" >&5
$as_echo "$as_me: WARNING: Unable to test Fortran compiler.  Compiling a test
program failed to produce an object file" >&2;}
	NOF77=1
	...
	{ $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: Unable to determine the form of Fortran external names.
Make sure that the compiler $F77 can be run on this system.
Turning off Fortran (-nof77 being assumed)" >&5
$as_echo "$as_me: WARNING: Unable to determine the form of Fortran external names.
Make sure that the compiler $F77 can be run on this system.
Turning off Fortran (-nof77 being assumed)" >&2;}
	NOF77=1
    fi
    fi
...
for ac_header in unistd.h fcntl.h malloc.h stddef.h sys/types.h limits.h time.h dirent.h
do :
  as_ac_Header=`$as_echo "ac_cv_header_$ac_header" | $as_tr_sh`
...
for ac_header in mpix.h
do :
  ac_fn_c_check_header_compile "$LINENO" "mpix.h" "ac_cv_header_mpix_h" "#include <mpi.h>
"
if test "x$ac_cv_header_mpix_h" = xyes; then :
  cat >>confdefs.h <<_ACEOF
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for int large enough for pointers" >&5
$as_echo_n "checking for int large enough for pointers... " >&6; }
if ${pac_cv_int_hold_pointer+:} false; then :
  $as_echo_n "(cached) " >&6
else
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: result: $pac_cv_int_hold_pointer" >&5
$as_echo "$pac_cv_int_hold_pointer" >&6; }
if test "$pac_cv_int_hold_pointer" != yes ; then

$as_echo "#define INT_LT_POINTER 1" >>confdefs.h


$as_echo "#define HAVE_INT_LT_POINTER 1" >>confdefs.h
...
$as_echo "#define MPI_OFFSET_IS_INT 1" >>confdefs.h

       LL="d"
       MPI_OFFSET_KIND1="!"
       MPI_OFFSET_KIND2="!"
    else
       { $as_echo "$as_me:${as_lineno-$LINENO}: defining MPI_Offset as long in C and integer in Fortran" >&5
$as_echo "$as_me: defining MPI_Offset as long in C and integer in Fortran" >&6;}
...
if test -n "$ac_cv_sizeof_long_long"; then
  ...
  { $as_echo "$as_me:${as_lineno-$LINENO}: checking if MPI_LONG_LONG_INT is defined in mpi.h" >&5
$as_echo_n "checking if MPI_LONG_LONG_INT is defined in mpi.h... " >&6; }
  rm -f mpitest.c
  cat > mpitest.c <<EOF
#include "mpi.h"
...
$as_echo "#define HAVE_MPI_LONG_LONG_INT /**/" >>confdefs.h
...
if test -z "$ac_f90ext" ; then
    if test -z "$FC" ; then
       ...
       for ac_prog in ifort pgf90 pathf90 pathf95 xlf90 xlf95 f90 epcf90 \
...
$as_echo_n "checking for extension for Fortran 90 programs... " >&6; }
    ac_f90ext="f90"
    ac_f90compile='${FC-f90} -c $FCFLAGS conftest.$ac_f90ext 1>&5'
    cat > conftest.$ac_f90ext <<EOF
      program conftest
      end
EOF
    if { { eval echo "\"\$as_me\":${as_lineno-$LINENO}: \"$ac_f90compile\""; } >&5
  (eval $ac_f90compile) 2>&5
  ac_status=$?
  $as_echo "$as_me:${as_lineno-$LINENO}: \$? = $ac_status" >&5
  test $ac_status = 0; } ; then
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for Fortran 90 KIND parameter for 8-byte integers" >&5
$as_echo_n "checking for Fortran 90 KIND parameter for 8-byte integers... " >&6; }
...
$as_echo "unavailable" >&6; }
 ...
 #
  if test "$FORTRAN_MPI_OFFSET" = "integer" && test "A$MPI_OFFSET_KIND2" = "A!" && test $NOF77 = 0 && test $NOF90 = 0 ; then
   { $as_echo "$as_me:${as_lineno-$LINENO}: checking for Fortran 90 KIND parameter for 4-byte integers" >&5
$as_echo_n "checking for Fortran 90 KIND parameter for 4-byte integers... " >&6; }
...
if test "$NOF77" = 0 ; then
    ...
    { $as_echo "$as_me:${as_lineno-$LINENO}: checking that we can use $FORTRAN_MPI_OFFSET to declare MPI_DISPLACMENT_CURRENT" >&5
$as_echo_n "checking that we can use $FORTRAN_MPI_OFFSET to declare MPI_DISPLACMENT_CURRENT... " >&6; }
    cat >conftest.f <<EOF
        program main
...
EOF
    ...
    rm -f conftest*
    { $as_echo "$as_me:${as_lineno-$LINENO}: result: $ac_cv_f77_offset_type_works" >&5
$as_echo "$ac_cv_f77_offset_type_works" >&6; }

    if test "$ac_cv_f77_offset_type_works" != "yes" -a -n "$MPI_OFFSET_KIND_VAL"; then
        { $as_echo "$as_me:${as_lineno-$LINENO}: checking whether we can use KIND with the selected F77 compiler $F77" >&5
$as_echo_n "checking whether we can use KIND with the selected F77 compiler $F77... " >&6; }
...
EOF
        ...
        rm -f conftest*
        { $as_echo "$as_me:${as_lineno-$LINENO}: result: $ac_cv_f77_allows_offset_kind" >&5
$as_echo "$ac_cv_f77_allows_offset_kind" >&6; }
        if test "$ac_cv_f77_allows_offset_kind" ; then
             FORTRAN_MPI_OFFSET="integer (kind=$MPI_OFFSET_KIND_VAL)"
        else
             { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: Could not find a way to declare an integer type corresponding to MPI_Offset in Fortran." >&5
$as_echo "$as_me: WARNING: Could not find a way to declare an integer type corresponding to MPI_Offset in Fortran." >&2;}
        fi
    fi
fi
...
if test $WITHIN_KNOWN_MPI_IMPL = no ; then
  ...
  { $as_echo "$as_me:${as_lineno-$LINENO}: checking if MPI_Info functions are defined in the MPI implementation" >&5
$as_echo_n "checking if MPI_Info functions are defined in the MPI implementation... " >&6; }
  rm -f mpitest.c
  cat > mpitest.c <<EOF
#include "mpi.h"
     main(int argc, char **argv)
...
$as_echo "#define HAVE_MPI_INFO 1" >>confdefs.h
...
if test -n "$mpi_sgi"; then
  ...
  { $as_echo "$as_me:${as_lineno-$LINENO}: checking if MPI_SGI_type_is_contig is defined" >&5
$as_echo_n "checking if MPI_SGI_type_is_contig is defined... " >&6; }
  rm -f mpitest.c
  cat > mpitest.c <<EOF
#include "mpi.h"
     main(int argc, char **argv)
...
$as_echo "#define NO_MPI_SGI_type_is_contig /**/" >>confdefs.h

  fi
  rm -f conftest$EXEEXT mpitest.c


  { $as_echo "$as_me:${as_lineno-$LINENO}: checking if MPI-2 combiners are defined in mpi.h" >&5
$as_echo_n "checking if MPI-2 combiners are defined in mpi.h... " >&6; }
  rm -f mpitest.c
  cat > mpitest.c <<EOF
#include "mpi.h"
     main(int argc, char **argv)
...
$as_echo "#define HAVE_MPI_COMBINERS /**/" >>confdefs.h
...
$as_echo "no" >&6; }
  ...
  { $as_echo "$as_me:${as_lineno-$LINENO}: checking if MPI_OFFSET_KIND is defined in mpif.h" >&5
$as_echo_n "checking if MPI_OFFSET_KIND is defined in mpif.h... " >&6; }
  rm -f mpitest.f
  cat > mpitest.f <<EOF
      program main
      implicit none
...
if test $WITHIN_KNOWN_MPI_IMPL = no ; then
  ...
  { $as_echo "$as_me:${as_lineno-$LINENO}: checking if darray and subarray constructors are defined in the MPI implementation" >&5
$as_echo_n "checking if darray and subarray constructors are defined in the MPI implementation... " >&6; }
  rm -f mpitest.c
  cat > mpitest.c <<EOF
#include "mpi.h"
     main(int argc, char **argv)
...
$as_echo "#define HAVE_MPI_DARRAY_SUBARRAY /**/" >>confdefs.h
...
if test $FROM_MPICH = yes ; then
         { $as_echo "$as_me:${as_lineno-$LINENO}: result: Overriding Array test for MPICH" >&5
$as_echo "Overriding Array test for MPICH" >&6; }
   unset BUILD_MPI_ARRAY

$as_echo "#define HAVE_MPI_DARRAY_SUBARRAY 1" >>confdefs.h
...
# still want tests built
 if test "x$NOF77" != "x1" && test "x$FROM_MPICH" != "xyes"; then
  BUILD_F77_BINDINGS_TRUE=
  BUILD_F77_BINDINGS_FALSE='#'
else
  BUILD_F77_BINDINGS_TRUE='#'
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking whether struct flock compatible with MPI_Offset" >&5
$as_echo_n "checking whether struct flock compatible with MPI_Offset... " >&6; }
cat confdefs.h - <<_ACEOF >conftest.$ac_ext
/* end confdefs.h.  */
#include <fcntl.h>
int
...
rm -f core conftest.err conftest.$ac_objext conftest.$ac_ext
{ $as_echo "$as_me:${as_lineno-$LINENO}: result: $pac_cv_struct_flock_and_mpi_offset" >&5
$as_echo "$pac_cv_struct_flock_and_mpi_offset" >&6; }
...
if test "$pac_cv_struct_flock_and_mpi_offset" = no ; then
    { $as_echo "$as_me:${as_lineno-$LINENO}: checking whether struct flock compatible with int" >&5
$as_echo_n "checking whether struct flock compatible with int... " >&6; }
    cat confdefs.h - <<_ACEOF >conftest.$ac_ext
/* end confdefs.h.  */
#include <fcntl.h>
int
...
rm -f core conftest.err conftest.$ac_objext conftest.$ac_ext
    { $as_echo "$as_me:${as_lineno-$LINENO}: result: $pac_cv_struct_flock_and_int" >&5
$as_echo "$pac_cv_struct_flock_and_int" >&6; }
    if test "$pac_cv_struct_flock_and_int" = yes ; then

$as_echo "#define NEEDS_INT_CAST_WITH_FLOCK 1" >>confdefs.h
...
if test -n "$FILE_SYSTEM" ; then
   ...
   do
      ...
      if test "$found" = "no" ; then
         { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: Unknown file system $x... proceeding anyway" >&5
$as_echo "$as_me: WARNING: Unknown file system $x... proceeding anyway" >&2;}
      fi
   done
fi
...
# Check whether --with-daos-include was given.
if test "${with_daos_include+set}" = set; then :
  withval=$with_daos_include; case "$withval" in #(
  yes|no|'') :
    { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: --without-daos-include=PATH expects a valid PATH" >&5
$as_echo "$as_me: WARNING: --without-daos-include=PATH expects a valid PATH" >&2;}
                          with_daos_include="" ;; #(
  *) :
     ;;
esac
...
# Check whether --with-daos-lib was given.
if test "${with_daos_lib+set}" = set; then :
  withval=$with_daos_lib; case "$withval" in #(
  yes|no|'') :
    { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: --without-daos-lib=PATH expects a valid PATH" >&5
$as_echo "$as_me: WARNING: --without-daos-lib=PATH expects a valid PATH" >&2;}
                          with_daos_lib="" ;; #(
  *) :
     ;;
esac
    ...
    case "${with_daos}" in
        embedded)
            as_fn_error $? "embedded daos is requested but we do not have the embedded version" "$LINENO" 5
            ;;
        yes|no)
            # skip
            ;;
        *)
    if test -n "${with_daos_include}"; then :


	if echo "$CPPFLAGS" | $FGREP -e "\<-I${with_daos_include}\>" >/dev/null 2>&1; then :
  echo "CPPFLAGS(='$CPPFLAGS') contains '-I${with_daos_include}', not appending" >&5
else
  echo "CPPFLAGS(='$CPPFLAGS') does not contain '-I${with_daos_include}', appending" >&5
		CPPFLAGS="$CPPFLAGS -I${with_daos_include}"

fi

else
  if test -n "${with_daos}"; then :


	if echo "$CPPFLAGS" | $FGREP -e "\<-I${with_daos}/include\>" >/dev/null 2>&1; then :
  echo "CPPFLAGS(='$CPPFLAGS') contains '-I${with_daos}/include', not appending" >&5
else
  echo "CPPFLAGS(='$CPPFLAGS') does not contain '-I${with_daos}/include', appending" >&5
    ...
    if test -n "${with_daos_lib}"; then :


	if echo "$LDFLAGS" | $FGREP -e "\<-L${with_daos_lib}\>" >/dev/null 2>&1; then :
  echo "LDFLAGS(='$LDFLAGS') contains '-L${with_daos_lib}', not appending" >&5
else
  echo "LDFLAGS(='$LDFLAGS') does not contain '-L${with_daos_lib}', appending" >&5
		LDFLAGS="$LDFLAGS -L${with_daos_lib}"
  ...
  if test -n "${with_daos}"; then :
	...
	if echo "$LDFLAGS" | $FGREP -e "\<-L${with_daos}/lib\>" >/dev/null 2>&1; then :
  echo "LDFLAGS(='$LDFLAGS') contains '-L${with_daos}/lib', not appending" >&5
else
  echo "LDFLAGS(='$LDFLAGS') does not contain '-L${with_daos}/lib', appending" >&5
		LDFLAGS="$LDFLAGS -L${with_daos}/lib"

fi

                  if test -d "${with_daos}/lib64"; then :


	if echo "$LDFLAGS" | $FGREP -e "\<-L${with_daos}/lib64\>" >/dev/null 2>&1; then :
  echo "LDFLAGS(='$LDFLAGS') contains '-L${with_daos}/lib64', not appending" >&5
else
  echo "LDFLAGS(='$LDFLAGS') does not contain '-L${with_daos}/lib64', appending" >&5
		LDFLAGS="$LDFLAGS -L${with_daos}/lib64"
    ...
    for ac_header in daos_types.h
do :
  ac_fn_c_check_header_mongrel "$LINENO" "daos_types.h" "ac_cv_header_daos_types_h" "$ac_includes_default"
if test "x$ac_cv_header_daos_types_h" = xyes; then :
  cat >>confdefs.h <<_ACEOF
#define HAVE_DAOS_TYPES_H 1
_ACEOF
  ...
  unset DAOS
    ...
    for ac_header in gurt/hash.h
do :
  ac_fn_c_check_header_mongrel "$LINENO" "gurt/hash.h" "ac_cv_header_gurt_hash_h" "$ac_includes_default"
if test "x$ac_cv_header_gurt_hash_h" = xyes; then :
  cat >>confdefs.h <<_ACEOF
#define HAVE_GURT_HASH_H 1
_ACEOF
  ...
  unset DAOS
    ...
    { $as_echo "$as_me:${as_lineno-$LINENO}: checking for d_hash_table_create in -lgurt" >&5
$as_echo_n "checking for d_hash_table_create in -lgurt... " >&6; }
if ${ac_cv_lib_gurt_d_hash_table_create+:} false; then :
  $as_echo_n "(cached) " >&6
else
  ac_check_lib_save_LIBS=$LIBS
LIBS="-lgurt  $LIBS"
...
extern "C"
#endif
char d_hash_table_create ();
int
main ()
{
return d_hash_table_create ();
  ;
  return 0;
}
_ACEOF
if ac_fn_c_try_link "$LINENO"; then :
  ac_cv_lib_gurt_d_hash_table_create=yes
else
  ac_cv_lib_gurt_d_hash_table_create=no
fi
rm -f core conftest.err conftest.$ac_objext \
    conftest$ac_exeext conftest.$ac_ext
LIBS=$ac_check_lib_save_LIBS
fi
{ $as_echo "$as_me:${as_lineno-$LINENO}: result: $ac_cv_lib_gurt_d_hash_table_create" >&5
$as_echo "$ac_cv_lib_gurt_d_hash_table_create" >&6; }
if test "x$ac_cv_lib_gurt_d_hash_table_create" = xyes; then :
  cat >>confdefs.h <<_ACEOF
#define HAVE_LIBGURT 1
_ACEOF
...
_ACEOF
  ...
  unset DAOS
    ...
    { $as_echo "$as_me:${as_lineno-$LINENO}: checking for dfs_mount in -ldfs" >&5
$as_echo_n "checking for dfs_mount in -ldfs... " >&6; }
if ${ac_cv_lib_dfs_dfs_mount+:} false; then :
  $as_echo_n "(cached) " >&6
else
  ac_check_lib_save_LIBS=$LIBS
LIBS="-ldfs  $LIBS"
...
_ACEOF
if ac_fn_c_try_link "$LINENO"; then :
  ac_cv_lib_dfs_dfs_mount=yes
else
  ac_cv_lib_dfs_dfs_mount=no
fi
rm -f core conftest.err conftest.$ac_objext \
    conftest$ac_exeext conftest.$ac_ext
LIBS=$ac_check_lib_save_LIBS
fi
{ $as_echo "$as_me:${as_lineno-$LINENO}: result: $ac_cv_lib_dfs_dfs_mount" >&5
$as_echo "$ac_cv_lib_dfs_dfs_mount" >&6; }
if test "x$ac_cv_lib_dfs_dfs_mount" = xyes; then :
  cat >>confdefs.h <<_ACEOF
#define HAVE_LIBDFS 1
_ACEOF
  ...
  unset DAOS
    ...
    { $as_echo "$as_me:${as_lineno-$LINENO}: checking for duns_resolve_path in -lduns" >&5
$as_echo_n "checking for duns_resolve_path in -lduns... " >&6; }
if ${ac_cv_lib_duns_duns_resolve_path+:} false; then :
  $as_echo_n "(cached) " >&6
else
  ac_check_lib_save_LIBS=$LIBS
LIBS="-lduns  $LIBS"
...
extern "C"
#endif
char duns_resolve_path ();
int
main ()
{
return duns_resolve_path ();
  ;
  return 0;
}
_ACEOF
if ac_fn_c_try_link "$LINENO"; then :
  ac_cv_lib_duns_duns_resolve_path=yes
else
  ac_cv_lib_duns_duns_resolve_path=no
fi
rm -f core conftest.err conftest.$ac_objext \
    conftest$ac_exeext conftest.$ac_ext
LIBS=$ac_check_lib_save_LIBS
fi
{ $as_echo "$as_me:${as_lineno-$LINENO}: result: $ac_cv_lib_duns_duns_resolve_path" >&5
$as_echo "$ac_cv_lib_duns_duns_resolve_path" >&6; }
if test "x$ac_cv_lib_duns_duns_resolve_path" = xyes; then :
  cat >>confdefs.h <<_ACEOF
#define HAVE_LIBDUNS 1
_ACEOF
...
$as_echo "#define ROMIO_DAOS 1" >>confdefs.h
	...
	as_fn_error $? "DAOS support requested but not found (--with-daos)" "$LINENO" 5
    fi
fi
...
# Extract the first word of "pvfs2-config", so it can be a program name with args.
set dummy pvfs2-config; ac_word=$2
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for $ac_word" >&5
$as_echo_n "checking for $ac_word... " >&6; }
if ${ac_cv_path_PVFS2_CONFIG+:} false; then :
  $as_echo_n "(cached) " >&6
else
  case $PVFS2_CONFIG in
  [\\/]* | ?:[\\/]*)
  ac_cv_path_PVFS2_CONFIG="$PVFS2_CONFIG" # Let the user override the test with a path.
  ;;
  *)
  as_save_IFS=$IFS; IFS=$PATH_SEPARATOR
as_dummy="${with_pvfs2}/bin:$PATH"
...
do
  ...
  test -z "$as_dir" && as_dir=.
    for ac_exec_ext in '' $ac_executable_extensions; do
  if as_fn_executable_p "$as_dir/$ac_word$ac_exec_ext"; then
    ac_cv_path_PVFS2_CONFIG="$as_dir/$ac_word$ac_exec_ext"
    $as_echo "$as_me:${as_lineno-$LINENO}: found $as_dir/$ac_word$ac_exec_ext" >&5
    break 2
  fi
done
...
IFS=$as_save_IFS
  ...
  test -z "$ac_cv_path_PVFS2_CONFIG" && ac_cv_path_PVFS2_CONFIG="notfound"
  ;;
esac
fi
PVFS2_CONFIG=$ac_cv_path_PVFS2_CONFIG
if test -n "$PVFS2_CONFIG"; then
  { $as_echo "$as_me:${as_lineno-$LINENO}: result: $PVFS2_CONFIG" >&5
$as_echo "$PVFS2_CONFIG" >&6; }
else
  { $as_echo "$as_me:${as_lineno-$LINENO}: result: no" >&5
$as_echo "no" >&6; }
fi
...
if test "$PVFS2_CONFIG" = "notfound" -a -n "$with_pvfs2" ; then
	as_fn_error $? "pvfs2-config not found in $with_pvfs2" "$LINENO" 5
fi
#############################################
...
# is daft enough to "m4_define([ufs],[some crazy value])".
 ...
 if test x$file_system_daos = x1; then
  BUILD_AD_DAOS_TRUE=
  BUILD_AD_DAOS_FALSE='#'
else
  BUILD_AD_DAOS_TRUE='#'
 ...
 if test x$file_system_nfs = x1; then
  BUILD_AD_NFS_TRUE=
  BUILD_AD_NFS_FALSE='#'
else
  BUILD_AD_NFS_TRUE='#'
 ...
 if test x$file_system_ufs = x1; then
  BUILD_AD_UFS_TRUE=
  BUILD_AD_UFS_FALSE='#'
else
  BUILD_AD_UFS_TRUE='#'
 ...
 if test x$file_system_testfs = x1; then
  BUILD_AD_TESTFS_TRUE=
  BUILD_AD_TESTFS_FALSE='#'
else
  BUILD_AD_TESTFS_TRUE='#'
 ...
 if test x$file_system_madfs = x1; then
  BUILD_AD_MADFS_TRUE=
  BUILD_AD_MADFS_FALSE='#'
else
  BUILD_AD_MADFS_TRUE='#'
 ...
 if test x$file_system_xfs = x1; then
  BUILD_AD_XFS_TRUE=
  BUILD_AD_XFS_FALSE='#'
else
  BUILD_AD_XFS_TRUE='#'
 ...
 if test x$file_system_panfs = x1; then
  BUILD_AD_PANFS_TRUE=
  BUILD_AD_PANFS_FALSE='#'
else
  BUILD_AD_PANFS_TRUE='#'
 ...
 if test x$file_system_gpfs = x1; then
  BUILD_AD_GPFS_TRUE=
  BUILD_AD_GPFS_FALSE='#'
else
  BUILD_AD_GPFS_TRUE='#'
 ...
 if test x$file_system_ime = x1; then
  BUILD_AD_IME_TRUE=
  BUILD_AD_IME_FALSE='#'
else
  BUILD_AD_IME_TRUE='#'
 ...
 if test x$file_system_quobytefs = x1; then
  BUILD_AD_QUOBYTEFS_TRUE=
  BUILD_AD_QUOBYTEFS_FALSE='#'
else
  BUILD_AD_QUOBYTEFS_TRUE='#'
...
#
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking configured file systems" >&5
$as_echo_n "checking configured file systems... " >&6; }
{ $as_echo "$as_me:${as_lineno-$LINENO}: result: $FILE_SYSTEM" >&5
$as_echo "$FILE_SYSTEM" >&6; }
...
if test -n "$file_system_panfs"; then
    ...
    ac_fn_c_check_header_mongrel "$LINENO" "pan_fs_client_cw_mode.h" "ac_cv_header_pan_fs_client_cw_mode_h" "$ac_includes_default"
if test "x$ac_cv_header_pan_fs_client_cw_mode_h" = xyes; then :

$as_echo "#define ROMIO_PANFS 1" >>confdefs.h

else
  as_fn_error $? "PANFS support requested but cannot find pan_fs_client_cw_mode.h header file" "$LINENO" 5

fi


    ac_fn_c_check_type "$LINENO" "pan_fs_client_raidn_encoding_t" "ac_cv_type_pan_fs_client_raidn_encoding_t" "#include <pan_fs_client_cw_mode.h>
"
if test "x$ac_cv_type_pan_fs_client_raidn_encoding_t" = xyes; then :

cat >>confdefs.h <<_ACEOF
#define HAVE_PAN_FS_CLIENT_RAIDN_ENCODING_T 1
_ACEOF
...
$as_echo "#define ROMIO_UFS 1" >>confdefs.h
...
$as_echo "#define ROMIO_GPFS 1" >>confdefs.h
...
$as_echo "#define BGQPLATFORM 1" >>confdefs.h
...
$as_echo "#define PEPLATFORM 1" >>confdefs.h
...
$as_echo "#define ROMIO_TESTFS 1" >>confdefs.h

fi


# Check whether --with-madfs was given.
if test "${with_madfs+set}" = set; then :
  withval=$with_madfs;
else
  with_madfs=no
fi
...
# Check whether --with-madfs-include was given.
if test "${with_madfs_include+set}" = set; then :
  withval=$with_madfs_include; case "$withval" in #(
  yes|no|'') :
    { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: --without-madfs-include=PATH expects a valid PATH" >&5
$as_echo "$as_me: WARNING: --without-madfs-include=PATH expects a valid PATH" >&2;}
                          with_madfs_include="" ;; #(
  *) :
     ;;
esac
...
# Check whether --with-madfs-lib was given.
if test "${with_madfs_lib+set}" = set; then :
  withval=$with_madfs_lib; case "$withval" in #(
  yes|no|'') :
    { $as_echo "$as_me:${as_lineno-$LINENO}: WARNING: --without-madfs-lib=PATH expects a valid PATH" >&5
$as_echo "$as_me: WARNING: --without-madfs-lib=PATH expects a valid PATH" >&2;}
                          with_madfs_lib="" ;; #(
  *) :
     ;;
esac
    ...
    case "${with_madfs}" in
        embedded)
            as_fn_error $? "embedded madfs is requested but we do not have the embedded version" "$LINENO" 5
            ;;
        yes|no)
            # skip
            ;;
        *)
    if test -n "${with_madfs_include}"; then :


	if echo "$CPPFLAGS" | $FGREP -e "\<-I${with_madfs_include}\>" >/dev/null 2>&1; then :
  echo "CPPFLAGS(='$CPPFLAGS') contains '-I${with_madfs_include}', not appending" >&5
else
  echo "CPPFLAGS(='$CPPFLAGS') does not contain '-I${with_madfs_include}', appending" >&5
		CPPFLAGS="$CPPFLAGS -I${with_madfs_include}"

fi

else
  if test -n "${with_madfs}"; then :


	if echo "$CPPFLAGS" | $FGREP -e "\<-I${with_madfs}/include\>" >/dev/null 2>&1; then :
  echo "CPPFLAGS(='$CPPFLAGS') contains '-I${with_madfs}/include', not appending" >&5
else
  echo "CPPFLAGS(='$CPPFLAGS') does not contain '-I${with_madfs}/include', appending" >&5
		CPPFLAGS="$CPPFLAGS -I${with_madfs}/include"
    ...
    if test -n "${with_madfs_lib}"; then :


	if echo "$LDFLAGS" | $FGREP -e "\<-L${with_madfs_lib}\>" >/dev/null 2>&1; then :
  echo "LDFLAGS(='$LDFLAGS') contains '-L${with_madfs_lib}', not appending" >&5
else
  echo "LDFLAGS(='$LDFLAGS') does not contain '-L${with_madfs_lib}', appending" >&5
		LDFLAGS="$LDFLAGS -L${with_madfs_lib}"
  ...
  if test -n "${with_madfs}"; then :
	...
	if echo "$LDFLAGS" | $FGREP -e "\<-L${with_madfs}/lib\>" >/dev/null 2>&1; then :
  echo "LDFLAGS(='$LDFLAGS') contains '-L${with_madfs}/lib', not appending" >&5
else
  echo "LDFLAGS(='$LDFLAGS') does not contain '-L${with_madfs}/lib', appending" >&5
		LDFLAGS="$LDFLAGS -L${with_madfs}/lib"

fi

                  if test -d "${with_madfs}/lib64"; then :


	if echo "$LDFLAGS" | $FGREP -e "\<-L${with_madfs}/lib64\>" >/dev/null 2>&1; then :
  echo "LDFLAGS(='$LDFLAGS') contains '-L${with_madfs}/lib64', not appending" >&5
else
  echo "LDFLAGS(='$LDFLAGS') does not contain '-L${with_madfs}/lib64', appending" >&5
		LDFLAGS="$LDFLAGS -L${with_madfs}/lib64"
...
_ACEOF
        ...
        unset MADFS
        as_fn_error $? "NO MADFS HEADER" "$LINENO" 5

fi

done

    { $as_echo "$as_me:${as_lineno-$LINENO}: checking for madfs_open in -lmadfs_server" >&5
$as_echo_n "checking for madfs_open in -lmadfs_server... " >&6; }
if ${ac_cv_lib_madfs_server_madfs_open+:} false; then :
  $as_echo_n "(cached) " >&6
else
  ac_check_lib_save_LIBS=$LIBS
LIBS="-lmadfs_server  $LIBS"
cat confdefs.h - <<_ACEOF >conftest.$ac_ext
/* end confdefs.h.  */
...
_ACEOF
if ac_fn_c_try_link "$LINENO"; then :
  ac_cv_lib_madfs_server_madfs_open=yes
else
  ac_cv_lib_madfs_server_madfs_open=no
fi
rm -f core conftest.err conftest.$ac_objext \
    conftest$ac_exeext conftest.$ac_ext
LIBS=$ac_check_lib_save_LIBS
fi
{ $as_echo "$as_me:${as_lineno-$LINENO}: result: $ac_cv_lib_madfs_server_madfs_open" >&5
$as_echo "$ac_cv_lib_madfs_server_madfs_open" >&6; }
if test "x$ac_cv_lib_madfs_server_madfs_open" = xyes; then :
  cat >>confdefs.h <<_ACEOF
#define HAVE_LIBMADFS_SERVER 1
_ACEOF
  ...
  LIBS="-lmadfs_server $LIBS"
        ...
        unset MADFS
        as_fn_error $? "NO MADFS LIBS" "$LINENO" 5
...
if test -n "$file_system_madfs" ; then
    if test "x$MADFS" == xyes ; then

$as_echo "#define ROMIO_MADFS 1" >>confdefs.h

    else
	    echo "MADFS support requested but not found (--with-madfs)" "$LINENO" 5
    fi
fi
